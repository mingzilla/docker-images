...
I want to test if you can do this, because this is using ollama with gemma4 model in claude code, please test, then tick or cross these boxes, if you can use multiple sub-agents to do this that would be even better
...
| Web search      | search the web for "ollama gemma4"                                            |        |
